                ...
                <Sidebar className={` lg:block border-r transition-all duration-300 ${toggle ? "w-10" : "w-64"}`} collapsible="icon">
                    ...
                    <SidebarContent className="sidebar_padding h-full">
                        <div className="p-4 text-gray-600">
                            ...
                            <Link to="/property/Ticket" className={`sidebar_link  flex items-center ${isActive("/property/Ticket")}`}>
                                <Ticket className="w-6 h-6 min-w-[20px]" />
                                <span className={`ml-3 transition-opacity duration-300 ${toggle ? "opacity-0 w-0" : "opacity-100 w-auto"}`}>
                                    Ticket
                                </span>
                            </Link>
                            <Link to="/property/roomlisting" className={`sidebar_link flex items-center ${isActive("/property/roomlisting")}`}>
                                <Ticket className="w-6 h-6 min-w-[20px]" />
                                <span className={`ml-3 transition-opacity duration-300 ${toggle ? "opacity-0 w-0" : "opacity-100 w-auto"}`}>
                                    Booking
                                </span>
