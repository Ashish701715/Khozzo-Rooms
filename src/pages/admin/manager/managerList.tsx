  ...
  <>
      ...
      <div className="flex justify-between mb-3 items-center from-blue-50 to-orange-50  ">
        ...
        <div className="text-gray-500 text-sm">
          Home <span className="text-blue-500">› Tenants</span>
        </div>

        {/* Button */}
        <button className="flex items-center gap-2 px-4 py-2 bg-blue-500 text-white rounded-full shadow-md hover:bg-blue-600 transition" onClick={handlenavigate}>
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-person-plus" viewBox="0 0 16 16">
            <path d="M6 8c1.654 0 3-1.346 3-3S7.654 2 6 2 3 3.346 3 5s1.346 3 3 3zm4 1h1V8a1 1 0 1 1 2 0v1h1a1 1 0 1 1 0 2h-1v1a1 1 0 1 1-2 0v-1h-1a1 1 0 1 1 0-2zM6 10c-2.507 0-6 1.252-6 3.75V15h7v-1c0-1.079.57-2.028 1.429-2.566A4.842 4.842 0 0 0 6 10z" />
          </svg>
          Add Manager
        </button>
      </div>
      ...
      <Table removeWrapper aria-label="Ticket Table">
        <TableHeader>
          ...
          <TableColumn className="table_header">Manager Name</TableColumn>
          <TableColumn className="table_header">Account No.</TableColumn>
          <TableColumn className="table_header">Address Line 1</TableColumn>
          <TableColumn className="table_header">Address Line 2</TableColumn>
          <TableColumn className="table_header">Contact No.</TableColumn>
