...
import { CheckCheck, EyeIcon, PencilIcon } from "lucide-react";
...
export default function PropertyAdminGrid(props: any) {
                ...
                <Row justify={'center'}>
                    {Array(4).fill(true).map((_, i) => (
                        <Col xs={{ span: 24 }} sm={{ span: 24 }} md={{ span: 12 }} lg={{ span: 12 }} xl={{ span: 6 }} xxl={{ span: 6 }} >
                           <div className="box_property border-b last:border-b-0 hover:shadow-xl hover:scale-105 hover:border hover:bg-white hover:text-black transition-all duration-300 ease-in-out cursor-pointer">


                                <div className="bg_property_img">
                                ...
                                <div className="content_pro">
                                    <Row>
                                        ...
                                        <Col span={18} xs={{ span: 16 }} sm={{ span: 16 }}>
