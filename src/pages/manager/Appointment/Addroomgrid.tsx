    ...
    <div className="flex flex-col p-6 bg-gray-100 min-h-screen">
      ...
      <div className="grid grid-cols-4 gap-4 mt-4">
        {displayedAppointments.map((appointment, index) => (
          <Card key={index} className={`p-4 border-l-4 ${appointment.Status === "Pending" ? "border-yellow-500" : appointment.Status === "Confirmed" ? "border-blue-500" : "border-green-500"} last:border-b-0 hover:shadow-xl hover:scale-100 hover:border hover:bg-white hover:text-black transition-all duration-300 ease-in-out cursor-pointer` }>
