...
//             document.title = `${payload} | APS Security`;
//         },
//     },
// });
...
const themeConfigSlice = createSlice({
    ...
    reducers: {
        ...
        toggleAnimation(state, { payload }: PayloadAction<string | undefined>) {
            payload = payload || state.animation; // animation class
            payload = payload?.trim();
            localStorage.setItem('animation', payload);
            state.animation = payload;
        },
        ...
        toggleSemidark(state, { payload }: PayloadAction<boolean | string>) {
            payload = payload === true || payload === 'true' ? true : false;
        ...
        toggleSidebar(state) {
            state.sidebar = !state.sidebar;
            localStorage.setItem('sidebar', String(state.sidebar)); // Save the sidebar state to localStorage
        },
